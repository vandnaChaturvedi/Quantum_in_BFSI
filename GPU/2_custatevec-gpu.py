...
# =================================================================
# PARALLEL LAUNCHER — 4 methods × 7x H100 80 GB
# =================================================================
if __name__ == "__main__":
    ...
    print("\n" + "="*65)
    print(f"  Launching 4 methods in parallel — 7x H100 80 GB")
    print("="*65 + "\n")
